...
export function QuickTasks({ onTaskClick, disabled = false }: QuickTasksProps) {
  return (
    <div className="px-6 pt-4 bg-gray-100 dark:bg-gray-950 transition-colors">
      <div className="mb-2">
